...
document.addEventListener('canvas', async function (data) {
    ...
    startThread.execute(function ({ system }) {
        ...
        const thread = system.createThread(function () {
            ...
            this.renderer = Renderer({ container, mode: 'canvas' })
            ...
            return {
                statements: sms,
                gos: initGos(_gos, system, this, system.plugin('canvasDrawer'))
            };
        });
