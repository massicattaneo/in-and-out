module.exports = function ({ password, footer, header, name }) {
    return `
    ${header(`Hola!`)}
    <!-- COPY -->
    <tr>
        <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: 'Arial', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
            <p style="margin: 0;">Aqui tienes tu codigo de seguridad: ${password}. Copialo y pegalo en nuestra pagina web.</p>
        </td>
    </tr>
    <!-- BULLETPROOF BUTTON -->
    <tr>
